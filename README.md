...
> [!WARNING]
> Despite the announcement made in the research paper, this implementation has been generalized to any value $N\geq 1$. See the [mathematical guide](https://github.com/remytuyeras/docs/guide.md) for more details on different parameter choices while keeping ACES secure.
>
...
> [!NOTE]
> Iddition to exploring the parameterization space of ACES, the [guide](https://github.com/remytuyeras/docs/guide.md) also elucidates specific technical aspects pertaining to the security of ACES. In particular, it gives useful recommendations on how to use ciphertexts in a secure way (for example see [important considerations](https://github.com/remytuyeras/docs/guide.md#important-considerations)).
>
