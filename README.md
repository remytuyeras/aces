<p align="center">
  <img width="300px" src="img/twofish.png" style="border:3px solid grey;"/>
...
> [!WARNING]
> Despite the announcement made in the research paper, this implementation has been generalized to any value $N\geq 1$. See the [mathematical guide](blob/main/README.md) for more details on different parameter choices while keeping ACES secure.
>
