...
> [!WARNING]
> Despite the announcement made in the research paper, this implementation has been generalized to any value $N\geq 1$. See the [mathematical guide](aces/GUIDE.md) for more details on different parameter choices while keeping ACES secure.
>
